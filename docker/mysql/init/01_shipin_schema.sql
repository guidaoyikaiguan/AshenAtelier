...
CREATE DATABASE IF NOT EXISTS `shipin`
...
INSERT IGNORE INTO `admin` (`admin_id`, `admin_name`, `password`) VALUES (1, 'admin', 'admin123');
...
CREATE TABLE IF NOT EXISTS `carousel` (
  ...
  `cover` varchar(500) NOT NULL COMMENT '轮播图图片URL',
...
-- AI 助手系统用户（user_id=0，用于 chat 外键约束）
SET SESSION sql_mode = 'NO_AUTO_VALUE_ON_ZERO';
INSERT IGNORE INTO `user` (`user_id`, `email`, `nick_name`, `password`, `create_time`, `state`) VALUES (0, 'ai@shipin.local', 'AI智能助手', 'system_ai_not_login', NOW(), 1);
